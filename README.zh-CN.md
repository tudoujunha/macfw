...
这类场景在最近越来越常见。很多人会把一台 Mac，特别是 Mac mini，当成一个长期运行的节点来使用，比如部署自动化工具、编码代理、模型运行环境、远程服务，或者把它当成一台小型家用服务器。这个时候，它的角色已经不再只是“日常主力电脑”，而更像一台 Linux VPS、NAS，或者长期在线的小型服务器。
